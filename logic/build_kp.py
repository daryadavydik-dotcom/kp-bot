...
def fill_template(template_bytes: bytes, replacements: dict, logos: dict | None = None) -> bytes:
    ...
    for ws in wb.worksheets:
        ...
        # Right logo: 108×120 (+30%) — col E+34px; bottom at 3rd-from-bottom text line
        _place(_get_img("right", _LOGO_RIGHT_PATH), row_0=0, col_0=4, col_off_px=34, row_off_px=37, w_px=108, h_px=120)
